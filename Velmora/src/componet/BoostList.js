                    ...
                    <div className="boost-projects">
                        ...
                        >
                            <div className="boost-card">
                                <div className="boost-boo">
                                    <img className="boost-card-image" src={boosteddeal.images[0]} alt={boosteddeal.description} width="200" />
                                </div>
                            
                                <div className="boost-card-body">
                                    <h5 className="boost-one-line-text">{boosteddeal.title}</h5>
                                    <p>₦ {boosteddeal.price.toLocaleString("en-NG")}</p>
                                    <p className="boost-cabo-h5">{boosteddeal.oldprice}</p>
                                </div>
                            </div>
                        </Link>
                        ))}
